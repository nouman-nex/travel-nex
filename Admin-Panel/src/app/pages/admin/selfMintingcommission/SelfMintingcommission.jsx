...
function SelfMintingcommission() {
  ...
  const getmintingCommission = () => {
    postRequest("/getAllMintingCommission", {}, (response) => {
      if (response.data.success) {
        ...
        const selfMinting = commissions.find(
          (item) => item.commissionType === "selfMinting"
        );

        if (selfMinting && selfMinting.rates) {
          const rates = selfMinting.rates;
          ...
          notify("Self Minting commission data not found", "error");
        }
      } else {
...
export default SelfMintingcommission;
