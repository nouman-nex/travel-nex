...
export default function CommunityAutoMintingBonusReport() {
      ...
      >
        ...
        >
          <Typography variant="h6">
            Community Auto Minting Bonus Transaction Details
          </Typography>
        ...
        <DialogContent dividers>
          <Grid container spacing={3}>
              ...
              >
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} sm={4}>
                    ...
                    <Chip
                      label="Community Auto Minting Bonus"
                      color="primary"
                      size="small"
                    />
                  </Grid>
            ...
            {/* Community Auto Minting Bonus Details */}
            <Grid item xs={12}>
              <Paper
                sx={{ p: 2, bgcolor: "background.paper", borderRadius: 1 }}
              >
        ...
        <>
          <div className="mb-8 border-b-2 border-gray-300 pb-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              >
                Community Auto Minting Bonus Reports
              </Typography>
            </div>
            <p className="text-gray-600 text-sm">
              Track your all Community Auto Minting Bonus history.
            </p>
          </div>
          ...
          <DataTable
            title="Community Auto Minting Bonus Reports"
            data={filteredTransactions}
            columns={columns}
            loading={loading}
            searchPlaceholder="Search by username or transaction ID..."
            emptyMessage="No Community Auto Minting Bonus transactions found"
