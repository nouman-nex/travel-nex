...
export default function CommunityBuildingBonusReport() {
      ...
      >
        ...
        >
          <Typography variant="h6">
            Community Building Bonus Transaction Details
          </Typography>
        ...
        <DialogContent dividers>
          <Grid container spacing={3}>
              ...
              >
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} sm={4}>
                    ...
                    <Chip
                      label="Community Building Bonus"
                      color="primary"
                      size="small"
                    />
                  </Grid>
            ...
            {/* Community Building Bonus Details */}
            <Grid item xs={12}>
              <Paper
                sx={{ p: 2, bgcolor: "background.paper", borderRadius: 1 }}
              >
        ...
        <>
          <div className="mb-8 border-b-2 border-gray-300 pb-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              >
                Community Building Bonus Reports
              </Typography>
            </div>
            <p className="text-gray-600 text-sm">
              Track your all Community Building Bonus history.
            </p>
          </div>
          ...
          <DataTable
            title="Community Building Bonus Reports"
            data={filteredTransactions}
            columns={columns}
            loading={loading}
            searchPlaceholder="Search by username or transaction ID..."
            emptyMessage="No Community Building Bonus transactions found"
