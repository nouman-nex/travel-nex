...
export default function BinaryCommissionReport() {
      ...
      >
        ...
        >
          <Typography variant="h6">
            Binary Commission Transaction Details
          </Typography>
        ...
        <>
          <div className="mb-8 border-b-2 border-gray-300 pb-4">
            ...
            <p className="text-gray-600 text-sm">
              Track your all Binary Commission history.
            </p>
          </div>
          ...
          <DataTable
            title="Binary Commission Reports"
            data={filteredTransactions}
            columns={columns}
            loading={loading}
            searchPlaceholder="Search by username or transaction ID..."
            emptyMessage="No Binary Commission transactions found"
