...
export default function AutoMintingBonusReport() {
      ...
      >
        ...
        >
          <Typography variant="h6">
            Auto Minting Bonus Transaction Details
          </Typography>
        ...
        <>
          <div className="mb-8 border-b-2 border-gray-300 pb-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              >
                Auto Minting Bonus Reports
              </Typography>
            </div>
            <p className="text-gray-600 text-sm">
              Track your all Auto Minting Bonus history.
            </p>
          </div>
          ...
          <DataTable
            title="Auto Minting Bonus Reports"
            data={filteredTransactions}
            columns={columns}
            loading={loading}
            searchPlaceholder="Search by username or transaction ID..."
            emptyMessage="No Auto Minting Bonus transactions found"
