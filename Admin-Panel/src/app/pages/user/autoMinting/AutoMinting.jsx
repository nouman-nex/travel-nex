        ...
        (response) => {
          ...
          if (response.data && response.data.success) {
            ...
            setNotifications((prev) => [
              ...
              {
                id: Date.now(),
                message: `Auto minting successful! +$${data.profitEarned.toFixed(4)} profit earned. Total profit: $${data.totalProfitEarned.toFixed(4)}`,
                type: "success",
              },
            ]);
        ...
        if (!activity.isEligible && newIsEligible) {
          setNotifications((prevNotifications) => [
            ...prevNotifications,
            {
              ...
              message: `Auto minting is now available for $${activity.investedAmount} investment!`,
              type: "info",
            },
          ]);
        }
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Typography
        ...
        sx={{ mb: 4 }}
      >
        Auto Minting ({mintingActivities.length} Active)
      </Typography>
      ...
      <Card elevation={2} sx={{ mt: 4, maxWidth: 600, mx: "auto" }}>
        <CardContent sx={{ p: 3 }}>
          <Typography
            ...
            align="center"
          >
            Auto Minting Benefits:
          </Typography>
          <Box>
            <Typography variant="body1" sx={{ mb: 1 }}>
              • 8% monthly profit automatically
            </Typography>
            <Typography variant="body1" sx={{ mb: 1 }}>
              • 250% total profit over 31.24 months
            </Typography>
            <Typography variant="body1">
