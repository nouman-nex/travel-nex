...
export default function CommunityAutoMintingReports() {
  ...
  const fetchTransactions = (page = 1, filter = null) => {
    ...
    const requestBody = {
      ...
      type: "community_auto_minting_bonus",
    };
  ...
  const columns = [
    {
      field: "_id",
      label: `${t("communityAutoMintingReports.transactionId")}`,
      renderCell: (row) => (
    ...
    {
      field: "amount",
      label: `${t("communityAutoMintingReports.amount")}`,
      renderCell: (row) => (
    ...
    },
    {
      ...
      label: `${t("communityAutoMintingReports.transactionFlow")}`,
      renderCell: (row) => (
        <Box
    ...
    {
      field: "paymentMethod",
      label: `${t("communityAutoMintingReports.paymentMethod")}`,
      renderCell: (row) => (
        <Chip
    ...
    {
      field: "status",
      label: `${t("communityAutoMintingReports.status")}`,
      renderCell: (row) => (
        <Chip
          label={row.status}
          color={
    ...
    {
      field: "createdAt",
      label: `${t("communityAutoMintingReports.date")}`,
  ...
  const filterOptions = [
    { value: "approved", label: `${t("communityAutoMintingReports.approved")}` },
    { value: "pending", label:`${t("communityAutoMintingReports.pending")}` },
    { value: "rejected", label: `${t("communityAutoMintingReports.rejected")}` },
  ];
    ...
    <>
      {activeFilter && (
        <Button
          ...
          sx={{ mr: 1 }}
        >
          {t("communityAutoMintingReports.clearFilters")}
        </Button>
      )}
      <Button
        variant="outlined"
        ...
        size="small"
      >
        {t("communityAutoMintingReports.refresh")}
      </Button>
    </>
  );
      ...
      >
        ...
        >
          <Typography variant="h6">
            {t("communityAutoMintingReports.modalTitle")}
          </Typography>
        ...
        <DialogContent dividers>
          <Grid container spacing={3}>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={6}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("communityAutoMintingReports.transactionId")}
                    </Typography>
                  ...
                  <Grid item xs={12} sm={6}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("communityAutoMintingReports.date")}
                    </Typography>
                  ...
                  <Grid item xs={12} sm={4}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("communityAutoMintingReports.type")}
                    </Typography>
                    <Chip label="Bonus" color="primary" size="small" />
                  </Grid>
                  <Grid item xs={12} sm={4}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("communityAutoMintingReports.amount")}
                    </Typography>
                    <Typography
                      variant="body1"
                      fontWeight="bold"
                  ...
                  <Grid item xs={12} sm={4}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("communityAutoMintingReports.status")}
                    </Typography>
                    <Chip
            ...
            <Grid item xs={12}>
              ...
              >
                <Typography variant="subtitle1" fontWeight="bold" gutterBottom>
                 {t("communityAutoMintingReports.transactionFlow")}
                </Typography>
                <Box
                ...
                >
                  <Box sx={{ textAlign: "center" }}>
                    <Typography
                      ...
                      gutterBottom
                    >
                      {t("communityAutoMintingReports.fromSender")}
                    </Typography>
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  ...
                  <Box sx={{ textAlign: "center" }}>
                    <Typography
                      ...
                      gutterBottom
                    >
                      {t("communityAutoMintingReports.toReceiver")}
                    </Typography>
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            ...
            <Grid item xs={12}>
              ...
              >
                <Typography variant="subtitle1" fontWeight="bold" gutterBottom>
                  {t("communityAutoMintingReports.bonusDetails")}
                </Typography>
                <Divider sx={{ mb: 2 }} />
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={6}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("communityAutoMintingReports.paymentMethod")}
                    </Typography>
                    <Typography variant="body1">
                  ...
                  {selectedTransaction.orderDetails && (
                    <>
                      <Grid item xs={12} sm={6}>
                        <Typography variant="subtitle2" color="text.secondary">
                         {t("communityAutoMintingReports.packageItem")}
                        </Typography>
                        <Typography variant="body1">
                      ...
                      <Grid item xs={12} sm={6}>
                        <Typography variant="subtitle2" color="text.secondary">
                          {t("communityAutoMintingReports.quantity")}
                        </Typography>
                        <Typography variant="body1">
                  ...
                  {selectedTransaction.status === "rejected" && (
                    <Grid item xs={12}>
                      <Typography variant="subtitle2" color="error">
                        {t("communityAutoMintingReports.rejectionReason")}
                      </Typography>
                      <Typography variant="body1">
                  ...
                  {selectedTransaction.notes && (
                    <Grid item xs={12}>
                      <Typography variant="subtitle2" color="text.secondary">
                        {t("communityAutoMintingReports.notes")}
                      </Typography>
                      <Typography variant="body1">
                        {selectedTransaction.notes}
                      </Typography>
        ...
        <DialogActions>
          <Button onClick={closeModal}>{t("communityAutoMintingReports.close")}</Button>
        </DialogActions>
      </Dialog>
    );
  };
    ...
    <Box sx={{ width: "100%", p: 2 }}>
      {error ? (
        <Box sx={{ p: 3, textAlign: "center" }}>
          ...
          >
            {t("communityAutoMintingReports.tryAgain")}
          </Button>
        </Box>
      ) : (
        <>
          <div className="mb-8 border-b-2 border-gray-300 pb-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              >
                {t("communityAutoMintingReports.title")}
              </Typography>
            </div>
            <p className="text-gray-600 text-sm">
              {t("communityAutoMintingReports.description")}
            </p>
          </div>
          {/* Summary Cards */}
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">
                    {t("communityAutoMintingReports.totalTransactions")}
                  </p>
                  <p
                    style={{ fontSize: 18 }}
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">{t("communityAutoMintingReports.totalAmount")}</p>
                  <p
                    style={{ fontSize: 18 }}
                    className="text-2xl text-gray-800"
                  >
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
              <div className="flex items-center justify-between mb-2">
                <p className="text-sm text-gray-600">{t("communityAutoMintingReports.lastTransactionDate")}</p>
          ...
          <DataTable
            title={t("communityAutoMintingReports.title")}
            data={filteredTransactions}
            columns={columns}
            loading={loading}
            searchPlaceholder={t("communityAutoMintingReports.searchPlaceholder")}
            emptyMessage={t("communityAutoMintingReports.emptyMessage")}
            filterOptions={filterOptions}
            onFilterChange={handleFilterChange}
            activeFilter={activeFilter}
            filterLabel={t("communityAutoMintingReports.filterByStatus")}
