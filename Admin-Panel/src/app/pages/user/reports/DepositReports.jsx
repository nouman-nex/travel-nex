...
export default function DepositReports() {
  ...
  const fetchTransactions = (page = 1, filter = null) => {
    ...
    const requestBody = {
      ...
      type: "deposit", // Only fetch transactions
    };
  ...
  const columns = [
    {
      field: "_id",
      label: t("depositReports.transactionId"),
      renderCell: (row) => (
    ...
    },
    {
      ...
      label: t("depositReports.transactionFlow"),
      renderCell: (row) => (
        <Box
    ...
    {
      field: "paymentMethod",
      label: t("depositReports.paymentMethod"),
      renderCell: (row) => (
        <Chip
 ...
 const filterOptions = [
    { value: "approved", label: `${t("depositReports.approved")}` },
    { value: "pending", label:`${t("depositReports.pending")}` },
    { value: "rejected", label: `${t("depositReports.rejected")}` },
  ];
  ...
  const renderTransactionModal = () => {
    ...
    return (
      ...
      >
        ...
        >
          <Typography variant="h6">{t("depositReports.modalTitle")}</Typography>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={6}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("depositReports.transactionId")}
                    </Typography>
                  ...
                  <Grid item xs={12} sm={4}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("depositReports.type")}
                    </Typography>
                    <Chip label="Bonus" color="primary" size="small" />
                  </Grid>
                  <Grid item xs={12} sm={4}>
                    <Typography variant="subtitle2" color="text.secondary">
                       {t("depositReports.amount")}
                    </Typography>
                    <Typography
                      variant="body1"
                      fontWeight="bold"
            ...
            <Grid item xs={12}>
              ...
              >
                <Typography variant="subtitle1" fontWeight="bold" gutterBottom>
                   {t("depositReports.transactionFlow")}
                </Typography>
                <Box
            ...
            <Grid item xs={12}>
              ...
              >
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={6}>
                    <Typography variant="subtitle2" color="text.secondary">
                       {t("depositReports.paymentMethod")}
                    </Typography>
                    <Typography variant="body1">
        ...
        <>
          <div className="mb-8 border-b-2 border-gray-300 pb-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              >
                {t("depositReports.title")}
              </Typography>
            </div>
            <p className="text-gray-600 text-sm">
               {t("depositReports.description")}
            </p>
          </div>
          {/* Summary Cards */}
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">
                    {t("depositReports.totalTransactions")}
                  </p>
                  <p
                    style={{ fontSize: 18 }}
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">{t("depositReports.totalAmount")}</p>
                  <p
                    style={{ fontSize: 18 }}
                    className="text-2xl text-gray-800"
                  >
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
              <div className="flex items-center justify-between mb-2">
                <p className="text-sm text-gray-600">{t("depositReports.lastTransactionDate")}</p>
          ...
          <DataTable
            title={t("depositReports.title")}
            data={filteredTransactions}
            columns={columns}
            loading={loading}
            searchPlaceholder={t("depositReports.searchPlaceholder")}
            emptyMessage={t("depositReports.emptyMessage")}
            filterOptions={filterOptions}
            onFilterChange={handleFilterChange}
            activeFilter={activeFilter}
            filterLabel={t("depositReports.filterByStatus")}
