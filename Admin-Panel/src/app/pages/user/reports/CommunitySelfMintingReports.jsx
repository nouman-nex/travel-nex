...
export default function CommunitySelfMintingReports() {
  ...
  const fetchTransactions = (page = 1, filter = null) => {
    ...
    const requestBody = {
      ...
      type: "community_self_minting_bonus",
    };
  ...
  const columns = [
    {
      field: "_id",
      label: `${t("communitySelfMintingReports.transactionId")}`,
      renderCell: (row) => (
    ...
    {
      field: "amount",
      label: `${t("communitySelfMintingReports.amount")}`,
      renderCell: (row) => (
    ...
    },
    {
      ...
      label: `${t("communitySelfMintingReports.transactionFlow")}`,
      renderCell: (row) => (
        <Box
    ...
    {
      field: "paymentMethod",
      label: `${t("communitySelfMintingReports.paymentMethod")}`,
      renderCell: (row) => (
        <Chip
    ...
    {
      field: "status",
      label: `${t("communitySelfMintingReports.status")}`,
      renderCell: (row) => (
        <Chip
          label={row.status}
          color={
    ...
    {
      field: "createdAt",
      label: `${t("communitySelfMintingReports.date")}`,
  ...
  const filterOptions = [
    { value: "approved", label: `${t("communitySelfMintingReports.approved")}` },
    { value: "pending", label:`${t("communitySelfMintingReports.pending")}` },
    { value: "rejected", label: `${t("communitySelfMintingReports.rejected")}` },
  ];
    ...
    <>
      {activeFilter && (
        <Button
          ...
          sx={{ mr: 1 }}
        >
          `${t("communitySelfMintingReports.clearFilters")}`
        </Button>
      )}
      <Button
        variant="outlined"
        ...
        size="small"
      >
        `${t("communitySelfMintingReports.refresh")}`
      </Button>
    </>
  );
      ...
      >
        ...
        >
          <Typography variant="h6">
            {t("communitySelfMintingReports.modalTitle")}
          </Typography>
        ...
        <DialogContent dividers>
          <Grid container spacing={3}>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={6}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("communitySelfMintingReports.transactionId")}
                    </Typography>
                  ...
                  <Grid item xs={12} sm={6}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("communitySelfMintingReports.date")}
                    </Typography>
                  ...
                  <Grid item xs={12} sm={4}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("communitySelfMintingReports.type")}
                    </Typography>
                    <Chip label="Bonus" color="primary" size="small" />
                  </Grid>
                  <Grid item xs={12} sm={4}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("communitySelfMintingReports.amount")}
                    </Typography>
                    <Typography
                      variant="body1"
                      fontWeight="bold"
                  ...
                  <Grid item xs={12} sm={4}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("communitySelfMintingReports.status")}
                    </Typography>
                    <Chip
            ...
            <Grid item xs={12}>
              ...
              >
                <Typography variant="subtitle1" fontWeight="bold" gutterBottom>
                  {t("communitySelfMintingReports.transactionFlow")}
                </Typography>
                <Box
                ...
                >
                  <Box sx={{ textAlign: "center" }}>
                    <Typography
                      ...
                      gutterBottom
                    >
                     {t("communitySelfMintingReports.fromSender")}
                    </Typography>
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  ...
                  <Box sx={{ textAlign: "center" }}>
                    <Typography
                      ...
                      gutterBottom
                    >
                      {t("communitySelfMintingReports.toReceiver")}
                    </Typography>
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            ...
            <Grid item xs={12}>
              ...
              >
                <Typography variant="subtitle1" fontWeight="bold" gutterBottom>
                  {t("communitySelfMintingReports.bonusDetails")}
                </Typography>
                <Divider sx={{ mb: 2 }} />
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={6}>
                    <Typography variant="subtitle2" color="text.secondary">
                     {t("communitySelfMintingReports.paymentMethod")}
                    </Typography>
                    <Typography variant="body1">
                  ...
                  {selectedTransaction.orderDetails && (
                    <>
                      <Grid item xs={12} sm={6}>
                        <Typography variant="subtitle2" color="text.secondary">
                          {t("communitySelfMintingReports.packageItem")}
                        </Typography>
                        <Typography variant="body1">
                      ...
                      <Grid item xs={12} sm={6}>
                        <Typography variant="subtitle2" color="text.secondary">
                          {t("communitySelfMintingReports.quantity")}
                        </Typography>
                        <Typography variant="body1">
                  ...
                  {selectedTransaction.status === "rejected" && (
                    <Grid item xs={12}>
                      <Typography variant="subtitle2" color="error">
                        {t("communitySelfMintingReports.rejectionReason")}
                      </Typography>
                      <Typography variant="body1">
                  ...
                  {selectedTransaction.notes && (
                    <Grid item xs={12}>
                      <Typography variant="subtitle2" color="text.secondary">
                        {t("communitySelfMintingReports.notes")}
                      </Typography>
                      <Typography variant="body1">
                        {selectedTransaction.notes}
                      </Typography>
        ...
        <DialogActions>
          <Button onClick={closeModal}>{t("communitySelfMintingReports.close")}</Button>
        </DialogActions>
      </Dialog>
    );
  };
    ...
    <Box sx={{ width: "100%", p: 2 }}>
      {error ? (
        <Box sx={{ p: 3, textAlign: "center" }}>
          ...
          >
            {t("communitySelfMintingReports.tryAgain")}
          </Button>
        </Box>
      ) : (
        <>
          <div className="mb-8 border-b-2 border-gray-300 pb-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              >
                ...
                {t("communitySelfMintingReports.title")}
              </Typography>
            </div>
            <p className="text-gray-600 text-sm">
              {t("communitySelfMintingReports.description")}
            </p>
          </div>
          {/* Summary Cards */}
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">
                   {t("communitySelfMintingReports.totalTransactions")}
                  </p>
                  <p
                    style={{ fontSize: 18 }}
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">{t("communitySelfMintingReports.totalAmount")}</p>
                  <p
                    style={{ fontSize: 18 }}
                    className="text-2xl text-gray-800"
                  >
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
              <div className="flex items-center justify-between mb-2">
                <p className="text-sm text-gray-600">{t("communitySelfMintingReports.lastTransactionDate")}</p>
          ...
          <DataTable
            title={t("communitySelfMintingReports.title")}
            data={filteredTransactions}
            columns={columns}
            loading={loading}
           searchPlaceholder={t("communitySelfMintingReports.searchPlaceholder")}
            emptyMessage={t("communitySelfMintingReports.emptyMessage")}
            filterOptions={filterOptions}
            onFilterChange={handleFilterChange}
            activeFilter={activeFilter}
            filterLabel={t("communitySelfMintingReports.filterByStatus")}
