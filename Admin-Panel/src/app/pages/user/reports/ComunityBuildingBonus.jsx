...
export default function ComunityBuildingBonus() {
  ...
  const columns = [
    {
      field: "_id",
      label: t("communityBuildingBonus.transactionId"),
      renderCell: (row) => (
    ...
    {
      field: "amount",
      label: t("communityBuildingBonus.amount"),
      renderCell: (row) => (
    ...
    },
    {
      ...
      label: t("communityBuildingBonus.transactionFlow"),
      renderCell: (row) => (
        <Box
    ...
    {
      field: "paymentMethod",
      label: t("communityBuildingBonus.paymentMethod"),
      renderCell: (row) => (
        <Chip
    ...
    {
      field: "status",
      label: t("communityBuildingBonus.status"),
      renderCell: (row) => (
        <Chip
          label={row.status}
          color={
    ...
    {
      field: "createdAt",
      label: t("communityBuildingBonus.date"),
  ...
  const filterOptions = [
  { value: "approved", label: t("communityBuildingBonus.approved") },
  { value: "pending", label: t("communityBuildingBonus.pending") },
  { value: "rejected", label: t("communityBuildingBonus.rejected") }
];
  ...
  const actionButtons = (
    <>
      ...
      <Button
        ...
        size="small"
      >
        {t("communityBuildingBonus.refresh")}
      </Button>
    </>
  );
      ...
      >
        ...
        >
          <Typography variant="h6">
            {t("communityBuildingBonus.modalTitle")}
          </Typography>
        ...
        <DialogContent dividers>
          <Grid container spacing={3}>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={6}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("communityBuildingBonus.transactionId")}
                    </Typography>
                  ...
                  <Grid item xs={12} sm={4}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("communityBuildingBonus.type")}
                    </Typography>
                    <Chip label="Bonus" color="primary" size="small" />
                  </Grid>
                  <Grid item xs={12} sm={4}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("communityBuildingBonus.amount")}
                    </Typography>
                    <Typography
                      variant="body1"
                      fontWeight="bold"
                  ...
                  <Grid item xs={12} sm={4}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("communityBuildingBonus.status")}
                    </Typography>
                    <Chip
            ...
            <Grid item xs={12}>
              ...
              >
                <Typography variant="subtitle1" fontWeight="bold" gutterBottom>
                  {t("communityBuildingBonus.transactionFlow")}
                </Typography>
                <Box
                ...
                >
                  <Box sx={{ textAlign: "center" }}>
                    <Typography
                      ...
                      gutterBottom
                    >
                      {t("communityBuildingBonus.fromSender")}
                    </Typography>
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  ...
                  <Box sx={{ textAlign: "center" }}>
                    <Typography
                      ...
                      gutterBottom
                    >
                      {t("communityBuildingBonus.toReceiver")}
                    </Typography>
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            ...
            <Grid item xs={12}>
              ...
              >
                <Typography variant="subtitle1" fontWeight="bold" gutterBottom>
                  {t("communityBuildingBonus.bonusDetails")}
                </Typography>
                <Divider sx={{ mb: 2 }} />
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={6}>
                    <Typography variant="subtitle2" color="text.secondary">
                      {t("communityBuildingBonus.paymentMethod")}
                    </Typography>
                    <Typography variant="body1">
                  ...
                  {selectedTransaction.orderDetails && (
                    <>
                      <Grid item xs={12} sm={6}>
                        <Typography variant="subtitle2" color="text.secondary">
                          {t("communityBuildingBonus.packageItem")}
                        </Typography>
                        <Typography variant="body1">
                      ...
                      <Grid item xs={12} sm={6}>
                        <Typography variant="subtitle2" color="text.secondary">
                          {t("communityBuildingBonus.quantity")}
                        </Typography>
                        <Typography variant="body1">
                  ...
                  {selectedTransaction.status === "rejected" && (
                    <Grid item xs={12}>
                      <Typography variant="subtitle2" color="error">
                        {t("communityBuildingBonus.rejectionReason")}
                      </Typography>
                      <Typography variant="body1">
                        {selectedTransaction.rejectionReason ||
                          t("communityBuildingBonus.noReasonProvided")}
                      </Typography>
                    </Grid>
                  )}
                  ...
                  {selectedTransaction.notes && (
                    <Grid item xs={12}>
                      <Typography variant="subtitle2" color="text.secondary">
                        {t("communityBuildingBonus.notes")}
                      </Typography>
                      <Typography variant="body1">
                        {selectedTransaction.notes}
                      </Typography>
        ...
        <DialogActions>
          <Button onClick={closeModal}>{t("communityBuildingBonus.close")}</Button>
        </DialogActions>
      </Dialog>
    );
  };
    ...
    <Box sx={{ width: "100%", p: 2 }}>
      {error ? (
        <Box sx={{ p: 3, textAlign: "center" }}>
          ...
          >
            {t("communityBuildingBonus.tryAgain")}
          </Button>
        </Box>
      ) : (
        <>
          <div className="mb-8 border-b-2 border-gray-300 pb-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              >
                {t("communityBuildingBonus.title")}
              </Typography>
            </div>
            <p className="text-gray-600 text-sm">
              {t("communityBuildingBonus.description")}
            </p>
          </div>
          {/* Summary Cards */}
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">
                    {t("communityBuildingBonus.totalTransactions")}
                  </p>
                  <p
                    style={{ fontSize: 18 }}
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">{t("communityBuildingBonus.totalAmount")}</p>
                  <p
                    style={{ fontSize: 18 }}
                    className="text-2xl text-gray-800"
                  >
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
              <div className="flex items-center justify-between mb-2">
                <p className="text-sm text-gray-600">{t("communityBuildingBonus.lastTransactionDate")}</p>
          ...
          <DataTable
           title={t("communityBuildingBonus.title")}
            data={filteredTransactions}
            columns={columns}
            loading={loading}
           searchPlaceholder={t("communityBuildingBonus.searchPlaceholder")}
            emptyMessage={t("communityBuildingBonus.emptyMessage")}
            filterOptions={filterOptions}
            onFilterChange={handleFilterChange}
            activeFilter={activeFilter}
            filterLabel={t("communityBuildingBonus.filterByStatus")}
